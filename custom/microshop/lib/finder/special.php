...
class microshop_finder_special {
    ...
    public $column_edit_special = '编辑';
    function column_edit_special($row) {
    
        return '<a href="index.php?app='.$_GET['app'].'&ctl=admin_special&act=edit&finder_id='.$_GET['_finder']['finder_id'].'&special_id='.$row['special_id'].'" target="dialog::{ title:\'' . app::get('b2c')->_('编辑专辑') . '\', width:800, height:470}" >' . $this->column_edit_special . '</a>';
    }
