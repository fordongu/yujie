...
$db['members'] = array(
    ...
    array(
        ...
        'sign_num' => array(
            'type' => 'int(2)',
            'default' => 0,
            'label' => app::get('b2c')->_('连续签到次数'),
        ),
        'follow_num' => array(
            'type' => 'int(10)',
            'default' => 0,
            'width' => 72,
            'label' => app::get('b2c')->_('关注人数'),
            'in_list' => true,
        ),
        'fans_num' => array(
            'type' => 'int(10)',
            'default' => 0,
            'width' => 72,
            'label' => app::get('b2c')->_('粉丝人数'),
            'in_list' => true,
        ),
        'avatar' =>
        array(
            'type' => 'varchar(255)',
            'comment' => app::get('b2c')->_('头像图片标识'),
            'editable' => false,
            'label' => app::get('b2c')->_('头像图片标识'),
            'in_list' => false,
            'default_in_list' => false,
        ),
        'cover' =>
        array(
            'type' => 'varchar(255)',
            'comment' => app::get('b2c')->_('封面图片标识'),
            'editable' => false,
            'label' => app::get('b2c')->_('封面图片标识'),
            'in_list' => false,
            'default_in_list' => false,
        ),
        'invite_mem_fid' => array(
            'type' => 'number',
            'label' => app::get('b2c')->_('邀请会员id'),
            'width' => 100,
            'default' => 0,
            'in_list' => true,
            'default_in_list' => true,
        ),
        'invite_mem_nums' => array(
            'type' => 'number',
            'default' => 0,
            'label' => app::get('b2c')->_('已邀请会员数量'),
            'width' => 70,
        ),
        'photo_nums' => array(
            'type' => 'number',
            'default' => 3,
            'label' => app::get('b2c')->_('照片打印数量'),
            'width' => 70,
        ),
        'is_invite' => array(
            'type' => array(
