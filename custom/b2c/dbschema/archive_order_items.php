...
$db['archive_order_items']=array (
  ...
  array (
    ...
    'obj_id' => 
    array (
      'type' => 'table:archive_order_objects:obj_id',
      'required' => true,
      'default' => 0,
      'editable' => false,
    ...
    array (
    		'type' => 'varchar(20)',
    		'default' => '',
    		'comment' => app::get('b2c')->_('推广代码'),
    ),
     'from_mem_id' =>  array (
      'type' => 'number',     
      'comment' => app::get('b2c')->_('商品所属会员'),
    ),
      
    'buy_mem_id' =>  array (
      'type' => 'number',     
      'comment' => app::get('b2c')->_('购买商品会员'),
    ),
      
    'gongxian' => array (
      'type' => 'money',     
      'comment' => app::get('b2c')->_('商品提成'),
    ),
  ),
  'index' => 
  array (
