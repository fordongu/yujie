...
$db['member_lv']=array (
  ...
  array (
    ...
    array (
      ...
      'in_list' => true,
      'default_in_list' => true,
      'comment' => app::get('b2c')->_('角色(分销/代理)'),
    ),
    'class' =>
    array (
      'label' => app::get('b2c')->_('等级'),
      'type' => array(
          'fou' => app::get('b2c')->_('四星'),
          'thr' => app::get('b2c')->_('三星'),
          'two' => app::get('b2c')->_('二星'),
          'one' => app::get('b2c')->_('一星'),
          'zero' => app::get('b2c')->_('无等级'),
      ),
      'default' => 'zero',
      'required' => true,
      'editable' => false,
