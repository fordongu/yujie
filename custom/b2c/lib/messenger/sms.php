...
//  var $targetSplit = ','; //多目标分隔符
    ...
    function send($to,$title,$message,$config){
        ...
        $setSmsSign = $setSmsSign ? $setSmsSign : 'good luck';
        ...
        $msg = kernel::single('b2c_messenger_smshuyi')->send($contents);
        //$result = kernel::single('b2c_messenger_smsgxt')->send($contents,$config,$msg);
        return $msg;
    }
    function checkL(){
