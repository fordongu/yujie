...
class b2c_mdl_goods_cat extends dbeav_model{
    ...
    public function getTree(){
         $res = $this->db->select('SELECT o.cat_name AS text,o.cat_id AS id,o.parent_id AS pid,o.p_order,o.cat_path,
    ...
    function get_cat_list($show_stable=false){
        if( base_kvstore::instance('b2c_goods')->fetch('goods_cat.data', $contents) !== false ){
			$contents = kernel::single('base_mdl_kvstore')->getList('value',array('key'=>'goods_cat.data'));
    ...
    function toRemove($catid,&$msg=''){
        ...
        if(count($aCats) > 0){
            //trigger_error(app::get('b2c')->_('ɾ��ʧ�ܣ����������滹���ӷ���'), E_USER_ERROR);
            $msg = 'ɾ��ʧ�ܣ����������滹���ӷ���';
            return false;
        }
        ...
        if(count($aGoods) > 0){
            //trigger_error(app::get('b2c')->_('ɾ��ʧ�ܣ����������滹����Ʒ'), E_USER_ERROR);
            $msg = 'ɾ��ʧ�ܣ����������滹����Ʒ';
            return false;
        }
