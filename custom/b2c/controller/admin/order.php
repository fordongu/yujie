...
class b2c_ctl_admin_order extends desktop_controller {
    ...
    public function _views() {
        ...
        $sub_menu = array(
            ...
            10 => array('label' => app::get('b2c')->_('取消订单'), 'optional' => false, 'filter' => array('disabled' => 'false')),
        );
        //新留言订单
    ...
    public function getAddr() {
        ...
        echo $obj_addr->get_receive_addr($this, $addr_id, $member_id, 'admin/order/rec_addr.html');
        exit;
    }
    ...
    public function gopay($order_id) {
        if (!$order_id) {
            header('Content-Type:text/jcmd; charset=utf-8');
            echo '{error:"' . app::get('b2c')->_("订单号传递出错.") . '",_:null}';
            exit;
        }
    ...
    public function dopay() {
        ...
        if (!$is_payed) {
            $db->rollback();
            header('Content-Type:text/jcmd; charset=utf-8');
            echo '{error:"' . app::get('b2c')->_("此次订单支付失败！") . '",_:null}';
            exit;
        }
        ...
        header('Content-Type:text/jcmd; charset=utf-8');
        echo '{success:"' . app::get('b2c')->_("此次订单支付成功！.") . '",_:null,order_id:"' . $_POST['order_id'] . '"}';
        exit;
    }
    ...
    public function total() {
        ...
        $sdf_order = $_POST;
        echo $obj_total->order_total_method($this, $arr_cart_objects, $sdf_order, "true", 'admin/order/checkout_total.html');
        exit;
    }
