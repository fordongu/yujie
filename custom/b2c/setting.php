...
'site.avatar'=>array('type'=>SET_T_IMAGE,'default'=>'669f61c74cc8624dc1156939682aacd3','desc'=>app::get('b2c')->_('默认头像'),'backend'=>'public','extends_attr'=>array('width'=>200,'height'=>95)),
...
'system.goods.commission'=>array('type'=>SET_T_INT,'default'=>3,'desc'=>app::get('b2c')->_('提成等级设置')),
'sign.days'=>array('type'=>SET_T_STR,'default'=>'7','desc'=>app::get('b2c')->_('连续签到天数')),
'system.bank.name'=>array('type'=>SET_T_STR,'default'=>'支付宝:建设银行','desc'=>app::get('b2c')->_('银行名称')),
