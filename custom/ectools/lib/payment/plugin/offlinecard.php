 ...
 */
final class ectools_payment_plugin_offlinecard extends ectools_payment_app implements ectools_interface_payment_app {
	/**
	 * @var string 支付方式名称
	 */
	public $name = '货到付款-pos刷卡';
	/**
     * @var string 支付方式接口名称
     */
    public $app_name = '货到付款-pos刷卡接口';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'offlinecard';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'offlinecard';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '货到付款-pos刷卡';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'CNY';
    ...
    public function setting(){
        return array(
                    ...
                    'is_cod'=>array(
                        'title'=>app::get('ectools')->_('是否开启货到付款'),
                        'type'=>'radio',
                        'options'=>array('false'=>app::get('ectools')->_('否'),'true'=>app::get('ectools')->_('是')),
                    	'label'=>app::get('ectools')->_('true 或 false'),
                    ),
					'status'=>array(
